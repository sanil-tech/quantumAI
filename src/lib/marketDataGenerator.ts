...
export const PAIR_CONFIGS: Record<CurrencyPair, { basePrice: number; decimals: number; pipValue: number; pipMultiplier: number }> = {
  ...
  'EUR/GBP': { basePrice: 0, decimals: 5, pipValue: 0, pipMultiplier: 10000 },
  'AUD/JPY': { basePrice: 0, decimals: 3, pipValue: 0, pipMultiplier: 100 },
  'EUR/CHF': { basePrice: 0, decimals: 5, pipValue: 0, pipMultiplier: 10000 },
  'EUR/AUD': { basePrice: 0, decimals: 5, pipValue: 0, pipMultiplier: 10000 },
  'GBP/AUD': { basePrice: 0, decimals: 5, pipValue: 0, pipMultiplier: 10000 },
