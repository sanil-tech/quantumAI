...
try {
 ...
 const end=Math.floor(Date.now()/3600000)*3600000, evaluationStart=(()=>{const d=new Date(end);d.setUTCMonth(d.getUTCMonth()-24);return d.getTime();})(), start=evaluationStart-30*86400000;
